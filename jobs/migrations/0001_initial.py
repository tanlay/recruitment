# Generated by Django 3.0.3 on 2021-01-20 13:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_type', models.SmallIntegerField(choices=[(0, '技术类'), (1, '产品类'), (2, '运营类'), (3, '设计类'), (4, '编辑类')], verbose_name='职位类别')),
                ...
                ('job_requrement', models.TextField(max_length=1024, verbose_name='职位要求')),
                ('created_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='创建时间')),
                ('updated_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='修改时间')),
